...
# Output
#	Archivo de ofertas validas PROCDIR/validas/<fecha_de_adjudicación >.txt
...
# De acuerdo al grupo: 
#	monto_mínimo = valor_de_cuota_pura * cantidad_de_cuotas_para_licitación
#	monto_máximo = valor_de_cuota_puta * cantidad_de_cuotas_pendientes
...
#	Si la cantidad de campos del primer registro no se corresponde con el formato establecido, asumir que el archivo está dañado
...
# 	CAMPOS:
#		-Contrato Fusionado [7]: Se debe validar contra el padrón de suscriptores MAEDIR/temaK_padron.csv (existe o no existe)
...
#		-Participa?:
#			Si en el padrón de suscriptores el suscriptor tiene la marca de participación en 1 o 2 puede participar. 
...
#	-La fecha de adjudicación del nombre del archivo a grabar se obtiene de la Tabla de Fechas de adjudicacion MAEDIR/fechas_adj.csv
#	corresponde con la fecha del próximo acto de adjudicación
